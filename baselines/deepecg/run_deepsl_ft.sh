...
#SBATCH --array=0-1
#SBATCH --output=/gpfs/projects/trend/bojun/multimodal_rep/eval/logs/deepsl_ft_%A_%a.out
#SBATCH --error=/gpfs/projects/trend/bojun/multimodal_rep/eval/logs/deepsl_ft_%A_%a.err
